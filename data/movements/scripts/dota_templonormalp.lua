local config = {
    rewards_id = {5957, 7440, 8306, 12328, 2494, 2472, 2514, 2493, 2470, 2195, 10502, 2160}, -- Rewards ID
    crystal_counts = 15, -- used only if on rewards_id you have crystal coins (ID: 2160).
    }
