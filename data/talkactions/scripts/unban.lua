...
if(account == 0) then
doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "Jogador ou conta '" .. param .. "' não existe.")
return true
end
...
doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "Banimento de IP em " .. doConvertIntegerToIp(ip) .. " foi levantado.")
end
...
doPlayerSendTextMessage(cid, MESSAGE_STATUS_CONSOLE_BLUE, "Namelock de " .. param .. " foi removido.")
end
