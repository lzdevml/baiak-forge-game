...
local config = {
	...
	msg = {
		help = "Use o comando exemplo: !mystic holy Efeitos disponíveis: ice, fire, earth, energy, holy, death, e none para desabilitar. A troca para outro elemento custa 10k.",
...
-- /////////////////////Requerimentos///////////////////--
local req_itemid = 12799                                  -- ID do item requerido
...
if getPlayerItemCount(cid, req_itemid) > 0 then
	if param == "help" or param == "" then
		doShowTextDialog(cid, 12799, string.format(config.msg.help, config.price))
		return true
	end
