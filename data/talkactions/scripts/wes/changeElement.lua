...
local config = {
	...
	msg = {
		help = "Use o comando exemplo: !wand holy Efeitos disponíveis: ice, fire, earth, energy, holy, death, e none para desabilitar. A troca para outro elemento custa 10k.",
...
-- /////////////////////Requerimentos///////////////////--
local req_itemid = 7958                                  -- ID do item requerido
...
if getPlayerItemCount(cid, req_itemid) > 0 then
	if param == "help" or param == "" then
		doShowTextDialog(cid, 7958, string.format(config.msg.help, config.price))
		return true
	end
