...
dtt = {
    pos = {
        temple_wait = {x = 229, y = 523, z = 7}, -- sala de espera
        tp_create = {x = 166, y = 52, z = 7}, -- onde teleport de entrada sera criado
    },
    ...
    townid = {init = 1, blue = 12, red = 13}, -- init = templo da cidade, blue = templo do time azul, red = templo do time vermelho

    --Configurações dos premios
    reward_items = {2160,50}, --Modelo: {ID, QUANTIA}
    bonus_time = 60, -- experiencia bonus em minutos
    bonus_rate = 1.0, -- porcentagem de experiencia bonus: 1.2 = 20% de bonus

    --Configuração dos monstros
    monster = {
    	pos = {
       		--Monstros do time azul
        	a1 = {x = 186, y = 523, z = 6, stackpos=253}, -- Blue supreme tower
        	a2 = {x = 219, y = 492, z = 6, stackpos=253}, -- Blue top tower
        	a3 = {x = 220, y = 520, z = 6, stackpos=253}, -- Blue middle tower
        	a4 = {x = 219, y = 552, z = 6, stackpos=253}, -- Blue bottom tower
        	-- Monstros do time vermelho
        	b1 = {x = 267, y = 523, z = 6, stackpos=253}, -- Red supreme tower
        	b2 = {x = 236, y = 492, z = 6, stackpos=253}, -- Red top tower 
        	b3 = {x = 235, y = 524, z = 6, stackpos=253}, -- Red middle tower 
        	b4 = {x = 236, y = 552, z = 6, stackpos=253}, -- Red bottom tower
        	-- Monstros buff na jungle
       		mbuff1 = {x = 232, y = 507, z = 6, stackpos=253}, -- Buff sorecer and paladin 1 + 2
        	mbuff2 = {x = 223, y = 537, z = 6, stackpos=253}, -- Buff druid and knight 2 + 2
    	},
        ---------------------------------------------------
    ...
    msg = {
        ...
        reward = "[Defend The Tower] Seu time Venceu, voce recebeu como premio 25 Tibia Token, 1 Double Boost e 25 Crystal Coins, parabens!",
...
function dtt.open()
	...
	if (isInArray(dtt.days_open, time.wday)) then
		...
		countDownTeleport(dtt.pos.tp_create, 300)
...
function dtt.close()
    for _, index in ipairs(dtt.getPlayersInEvent()) do
        ...
        unregisterCreatureEvent(cid, "dttDeath")
        unregisterCreatureEvent(cid, "dttPrepare")
        unregisterCreatureEvent(cid, "dttStats")
        unregisterCreatureEvent(cid, "dttOutfit")
        unregisterCreatureEvent(cid, "dttKill") 
        unregisterCreatureEvent(cid, "dttCombat")
    end
...
function dtt.reward(pid)
    ...
    doPlayerAddItem(pid, 6527, 25)
    doPlayerAddItem(pid, 12544, 1)
