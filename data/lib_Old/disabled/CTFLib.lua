...
CTF_LIB = {
	waitpos = {x = 708, y = 31814, z = 8}, -- Posição da sala de espera
	tppos = {x = 152, y = 48, z = 7}, -- Onde o TP vai aparecer
	...
	teams = {
		["Vermelho"] = {
			temple = 30, -- TownID da equipe vermelha
			outfit = {lookHead = 0, lookBody = 132, lookLegs = 113, lookFeet = 94},

			flag = {
				id = 1435,
				flag_pos = {x = 789, y = 31820, z = 7}, -- Posição onde a bandeira vermelha vai ser criada
				gnd_pos = {x = 735, y = 31822, z = 7}, -- Onde os players da equipe vermelha entregarão a bandeira.
			},
		},
		["Verde"] = {
			temple = 31, -- TownID da equipe verde 
			outfit = {lookHead = 0, lookBody = 121, lookLegs = 101, lookFeet = 101},

			flag = {
				id = 1437,
				flag_pos = {x = 735, y = 31820, z = 7}, -- Posição onde a bandeira verde vai ser criada
				gnd_pos = {x = 789, y = 31822, z = 7}, -- Onde os players da equipe verde entregarão a bandeira.
			},
		},
	},
}
