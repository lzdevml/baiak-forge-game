...
POSITION_REWARD = {x = 597, y = 594, z = 6}
POSITION_KICK = {x = 626, y = 612, z = 6}
 
--Just paste here the positions of the first pit and script will configure positions for other pits.
FIRST_PIT =
{
	fromPos = {x = 580, y = 608, z = 7}, 
	toPos = {x = 589, y = 617, z = 7},
	center = {x = 585, y = 612, z = 7},
	pillar = {x = 579, y = 612, z = 7},
	tp = {x = 579, y = 612, z = 7},
	summon = {x = 585, y = 614, z = 7}
}
