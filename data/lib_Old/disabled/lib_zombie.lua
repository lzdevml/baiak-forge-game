...
zombieEvent = {
	config = {
		startTime = {
			[1] = {"10:00", "19:00"}, -- domingo
			[2] = {"10:00", "19:00"}, -- segunda
			[3] = {"10:00", "19:00"}, -- terça
			[4] = {"10:00", "19:00"}, -- quarta
			[5] = {"10:00", "19:00"}, -- quinta
			[6] = {"10:00", "19:00"}, -- sexta
			[7] = {"10:00", "19:00"}  -- sabado
		},
		...
		minPlayers = 5, -- Quantidade minima de jogadores para iniciar o evento
