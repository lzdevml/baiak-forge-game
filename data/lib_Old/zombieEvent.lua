zombieEvent = {
	config = {
		startTime = {
			[1] = {"09:30", "22:40", "01:00", "17:00"}, -- domingo
			[2] = {"09:30", "22:40", "01:00", "17:00"}, -- segunda
			[3] = {"09:30", "22:40", "01:00", "17:00"}, -- terça
			[4] = {"09:30", "22:40", "01:00", "17:00"}, -- quarta
			[5] = {"09:30", "22:40", "01:00", "17:00"}, -- quinta
			[6] = {"09:30", "22:40", "01:00", "17:00"}, -- sexta
			[7] = {"09:30", "19:50", "01:00", "17:00"}  -- sabado
		},

		messages = {
			announcement = "[Zombie Event] O ataque de zombies esta prestes a começar, o teleport será fechado em %d minuto",
			startEvent = "[Zombie Event] O teleporte fechou, boa sorte aos participantes!",
			playerBitten = "O jogador %s acaba de ser mordido e agora está no time dos zombies!",
			endEvent = "[Zombie Event] %s foi o sobrevivente do ataque de zombies! Párabens!",
			notEnoughPlayers = "[Zombie Event] Apenas %d jogadores não é o suficiente para se defender de um ataque zombie. Os zombies venceram antes mesmo do ataque começar.",

			zombiesRant = {"Mst.... klll....", "Whrrrr... ssss.... mmm.... grrrrl", "Dnnnt... cmmm... clsrrr....", "Httt.... hmnnsss...", "Uhhhhhhh!", "Aaaaahhhh!", "Hoooohhh!", "Chhhhhhh!"}
		},

		minPlayers = 2, -- Quantidade minima de jogadores para iniciar o evento
		...
		zombieRatio = 0.5, -- Quantidade inicial de Zombies = [quantidade de players no evento multiplicado pelo valor definido aqui]
		playerSpeed = 300,
		delayToTransform = 3, -- Tempo em segundos para o jogador que foi mordido virar um zombie
		allowMultiClient = false,

		rewards = {
			human = {{8981, 5}, {6527, 50}}, -- {id, count}
			zombie = {{6527, 15}} -- {id, count}
		},
		...
		area = {
			fromPos = {x=1930, y=157}, -- Coordenadas ponto superior-esquerdo
			toPos = {x=1960, y=187}, -- Coordenadas ponto inferior-direito
			z = 7,
		},

		teleportAid = 1800,
		teleportPos = {x=151, y=43, z=7}, -- Onde o teleporte pra entrada do evento vai ser criado.
	},
