...
if (getCreatureOutfit(npc).lookType == 132) then
      doCreatureChangeOutfit(npc, {lookType = 798, lookHead = 91, lookBody = 91, lookLegs = 91, lookFeet = 91, lookTypeEx = 91, lookAddons = 3})
else 
      doCreatureChangeOutfit(npc, {lookType = 132, lookHead = 114, lookBody = 114, lookLegs = 114, lookFeet = 114, lookTypeEx = 114, lookAddons = 3})  
end
npcHandler:onThink()
end
...
function creatureSayCallback(cid, type, msg)
        ...
        local table_left_pos = {x = 118, y = 52, z = 6} -- Pos da frente do Npc onde gira o dado
        local table_middle_pos = {x = 118, y = 53, z = 6} -- Pos do meio onde vai o dinheiro
        ...
        posplayer = {x = 119, y = 54, z = 6} -- Pos onde o player precisa estar
