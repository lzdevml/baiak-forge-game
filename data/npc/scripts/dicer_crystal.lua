...
function creatureSayCallback(cid, type, msg)
        ...
        local table_left_pos = {x = 149, y = 54, z = 5} -- Pos da frente do Npc onde gira o dado
        local table_middle_pos = {x = 149, y = 55, z = 5} -- Pos do meio onde vai o dinheiro
        ...
        posplayer = {x = 150, y = 56, z = 5} -- Pos onde o player precisa estar
