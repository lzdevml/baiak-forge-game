...
local data = {
	[14007] = {'crocodile', 'Happy hunting, old chap! Come back to me when you are through with your task.', 'Voce ja matou %u crocodiles. Volte quando tiver completado.', 'Spiffing work, old chap. Now I have a special task for you. Recently several citizens of Port Hope have vanished. It is rumoured that they were killed by a crocodile. The people call it \'Snapper\'. Hunt down and kill that evil man eating beast.', 800, 1, 'Snapper', },
	[14008] = {'tarantula', 'Happy hunting, old chap! Come back to me when you are through with your task.', 'Voce ja matou %u tarantulas. Volte quando tiver completado.', 'Nicely done! Now I shall assign you a special task. Rumour has it that there is an ancient and evil tarantula who preys on humans. She is called \'Hide\'. Track her down and kill her! Good luck, old chap.', 1500, 1, 'Hide'},
	[14009] = {'carniphila', 'Good show, old chap! Speak to me again when you are done hunting.', 'Voce ja matou %u carniphilas. Volte quando tiver completado.', 'That took some time, huh? Good hunting though. If you\'re up for another hunting mission just ask me for a {task}.', 1500, 1},
	[14010] = {'stone golem', 'Happy hunting, friend! When you have finished hunting, return here. ', 'Voce ja matou %u stone golems. Volte quando tiver completado.', 'Good show, old chap. If you\'re up for another hunting mission just ask me for a task.', 2000, 1},
	[14011] = {'mammoth', 'Happy hunting, friend! Come back to me when you are done hunting.', 'Voce ja matou %u mammoths. Volte quando tiver completado.', 'Jolly good job you did there, but now I have a special task for you. The citizens of Svargrond live in fear because of a frightfully bad-tempered mammoth they call \'Blood Tusk\'. Go there and put an end to him. Happy hunting!', 'Bloodtusk', 4000, 1},
	[14012] = {'ice golem', 'Happy hunting, friend! Come back to me when you are done hunting.', 'Voce ja matou %u ice golems. Volte quando tiver completado.', 'As i see it, you need more of a challenge! I have heard that there is an ice golem the hunters in Svargrond call \'Shardhead\'. He is an extremely dangerous example of his kind! I believe you are equal to the task, %s!', 15000, 1, 'Shardhead'},
	[14013] = {'quara constrictor scout', 'Happy hunting, friend! Come back to me when you are done hunting.', 'Alright, then you should go on with your task. You have already killed %u quara scouts in total. Volte quando tiver completado.', 'Jolly good show! What a hunter! If you\'re up for another hunting mission just ask me for a {task}.', 10000, 1}, -- ?
	[14014] = {'quara constrictor', 'Happy hunting, friend! Come back to me when you are done hunting.', 'Alright, then you should go on with your task. You have already killed %u underwater quaras in total. Volte quando tiver completado.', 'Superb work. However, there is something else I want you to do. It is said that there is a Quara general named \'Thul\' who is responsible for the attacks on Liberty Bay. Find him and kill him and bring peace to Liberty bay!', 12000, 1, 'Thul'}, -- OK
	[14015] = {'water elemental', 'Happy hunting, my old mocker! Come back to me when you are done hunting. ', 'Voce ja matou %u water elementals. Volte quando tiver completado.', 'Fantastic! If you\'re up for another hunting mission just ask me for a {task}.', 7000, 1},
	[14016] = {'earth elemental', 'Happy hunting, friend! Come back to me when you are done hunting. ', 'Voce ja matou %u earth elementals. Volte quando tiver completado.', 'Fantastic! If you\'re up for another hunting mission just ask me for a {task}.', 10000, 1},
	[14017] = {'energy elemental', 'Happy hunting, pal! Come back to me when you are done hunting. ', 'Voce ja matou %u energy elementals. Volte quando tiver completado.', 'Fantastic! If you\'re up for another hunting mission just ask me for a {task}.', 10000, 1},
	[14018] = {'fire elemental', 'Happy hunting, old friend! Come back to me when you are done hunting. ', 'Voce ja matou %u fire elementals. Volte quando tiver completado.', 'Fantastic! If you\'re up for another hunting mission just ask me for a {task}.', 7000, 1},
	[14019] = {'mutated rat', 'Happy hunting, old chap! Come back to me when you are done hunting. ', 'Alright, then stop dilly dallying here and go on with your task. You have already exterminated %u mutated rats. Volte quando tiver completado.', {'Very good work, old chap. Lucky you are here - I have just been told of a task which is perfect for you. ...', 'The Yalaharians are having a spot of bother with a huge mutated rat. They call it \'Esmeralda\' and you should find her somewhere in the sewers. Good hunting!'}, 10000, 1, 'Esmeralda'}, -- OK
	[14020] = {'giant spider', 'Jolly good show! Come back to me when you are done hunting. ', 'Voce ja matou %u giant spiders. Volte quando tiver completado.', 'Well THAT was a hunt. Good job. Have you heared about \'The Old Widow\'? It must have a hideout. Try to find it and slay the beast.', 5000, 1, 'Old Widow'},
	[14021] = {'hydra', 'Happy hunting, old chap! Come back to me when you are done hunting.', 'Voce ja matou %u hydras. Volte quando tiver completado.', {'With Nornur the God of Fate as my witness, you are truly born to hunt. If anyone can do this task, you can! Listen: ...', 'It is said that the Lizards of Chor are training hydras for attacks against us. They have already successfully bred a hydra named \'The Many\'. Find her and kill her!'}, 0, 2, 'Many'},
	[14001] = {'sea serpent', 'Happy hunting, old chap! Come back to me when you are done hunting.', 'Voce ja matou %u sea serpents. Volte quando tiver completado.', 'Good job, old chap! Are you up for a challenge? Have you heard of the legendary sea serpent called \'The Leviathan\'? It must be somewhere near the spot you found. This is a true test of your hunting skills - find it and kill it. Good hunting!', 0, 2, 'Leviathan'},
	[14022] = {'behemoth', 'Happy hunting, old chap! Come back to me when you are done hunting.', 'Voce ja matou %u behemoths. Volte quando tiver completado.', 'Such marvellous hunting skills! Perhaps you can help me with this one. Have you heard about \'Stonecracker\'? ...', 0, 2, 'Stonecracker'}, -- OK
	[14002] = {'serpent spawn', 'Happy hunting, old chap! Come back to me when you are done hunting.', 'Voce ja matou %u serpent spawns. Volte quando tiver completado.', 'My - you can be proud of yourself! However, you\'re not finished yet. There are rumours about a being called \'The Noxious Spawn\' which was seen deep down in the ruins of Banuta. Try to find its hideout.', 0, 2, 'Noxious Spawn'},
}
...
function greetCallback(cid)
	...
	elseif cur >= 50 and r < 5 then
		...
		msg = 'Bem vindo novamente |PLAYERNAME|. Diga {Task}'
	end
...
function creatureSayCallback(cid, _type, msg)
	...
	if msgcontains(msg, 'task') then
		...
		if cur < 1 or (cur ~= 14006 and getPlayerStorageValue(cid, cur) == tasks[data[cur][1]].amount + 1 and getPlayerStorageValue(cid, cur + 100) == -1) then
			...
			elseif 1 <= lvl then
				v, Topic[cid] = '{Hydras}, {sea serpents}, {behemoths}, {Ice golems}, {Quara}, {mutated rats}, {giant spiders}, {Crocodiles}, {tarantulas}, {carniphilas}, {stone golems} or {mammoths}' .. (getPlayerStorageValue(cid, rank) == 5 and ', {serpent spawns} or {demons}' or ' or {serpent spawns}'), 3
			end
		...
		elseif getPlayerStorageValue(cid, cur + 100) == 2 then
			...
			selfSay(getPlayerStorageValue(cid, cur + 100) < 1 and 'Voce ainda nao terminou sua task.Diga {sair} da task atual ou {info} para saber informacoes.' or string.format('Find %s\'s hideout. I hope for you that you are skilled enough to kill him. Or do you want to abort your task to start a different one?', data[cur][7]), cid)
			Topic[cid] = 4
		end
	...
	elseif Topic[cid] == 4 then
		local cur = getPlayerStorageValue(cid, curTask)
		if msgcontains(msg, 'sair') or msgcontains(msg, 'abort') then
			selfSay('Voce saiu da task, agora nao esta em mais nenhuma, diga {task} para inicar uma nova.', cid)
			...
			selfSay(cur == 14006 and string.format('Alright, then stop dilly dallying here and go on with your task. You have already exterminated %u demons. Volte quando tiver completado.', getPlayerStorageValue(cid, cur)) or getPlayerStorageValue(cid, cur + 100) < 1 and string.format(data[getPlayerStorageValue(cid, curTask)][3], getPlayerStorageValue(cid, cur)) or 'Alright, then you should go on with your task.', cid)
		end
		Topic[cid] = 0
	elseif Topic[cid] == 3 and msgcontains(msg, 'crocodile') then
		...
		Topic[cid] = v.storage
	elseif Topic[cid] == 3 and msgcontains(msg, 'tarantula') then
		...
		Topic[cid] = v.storage
	elseif Topic[cid] == 3 and msgcontains(msg, 'carniphila') then
		...
		Topic[cid] = v.storage
	elseif Topic[cid] == 3 and msgcontains(msg, 'golem') then
		...
		Topic[cid] = v.storage
	elseif Topic[cid] == 3 and msgcontains(msg, 'mammoth') then
	...
	elseif Topic[cid] == 3 and msgcontains(msg, 'golem') then
		...
		Topic[cid] = v.storage
	elseif Topic[cid] == 3 and msgcontains(msg, 'quara') then
	...
	elseif Topic[cid] == 5 and msgcontains(msg, 'underwater') then
		...
		Topic[cid] = v.storage
	elseif Topic[cid] == 3 and msgcontains(msg, 'elemental') then
	...
	elseif Topic[cid] == 6 and msgcontains(msg, 'fire') then
		...
		Topic[cid] = v.storage
	elseif Topic[cid] == 3 and msgcontains(msg, 'mutated rat') then
		...
		Topic[cid] = v.storage
	elseif Topic[cid] == 3 and msgcontains(msg, 'giant spider') then
	...
	elseif Topic[cid] >= 14000 and msgcontains(msg, 'yes') then
		...
		Topic[cid] = 0
	elseif msgcontains(msg, 'info') and getPlayerStorageValue(cid, rank) == 5 then
