...
if (getCreatureOutfit(npc).lookType == 132) then
      doCreatureChangeOutfit(npc, {lookType = 798, lookHead = 94, lookBody = 94, lookLegs = 94, lookFeet = 94, lookTypeEx = 94, lookAddons = 3})
else 
      doCreatureChangeOutfit(npc, {lookType = 132, lookHead = 79, lookBody = 79, lookLegs = 79, lookFeet = 79, lookTypeEx = 79, lookAddons = 3})  
end
npcHandler:onThink()
end
...
function creatureSayCallback(cid, type, msg)
        ...
        local table_left_pos = {x = 147, y = 48, z = 7} -- Pos da frente do Npc onde gira o dado
        local table_middle_pos = {x = 146, y = 48, z = 7} -- Pos do meio onde vai o dinheiro
        ...
        posplayer = {x = 145, y = 49, z = 7} -- Pos onde o player precisa estar
