...
local travelNode = keywordHandler:addKeyword({"venom"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Gostaria de acessar a cidade de Venom?"})
	travelNode:addChildKeyword({"yes"}, StdModule.travel, {npcHandler = npcHandler, premium = false, level = 0, cost = 30, destination = {x=2912, y=2918, z=6} })
	travelNode:addChildKeyword({"no"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, reset = true, text = "We would like to serve you some time."})

local travelNode = keywordHandler:addKeyword({"skyler"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Gostaria de acessar a cidade NO-PVP de Skyler?"})
...
local travelNode = keywordHandler:addKeyword({"baiak city"}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "Gostaria de voltar para Baiak City?"})
