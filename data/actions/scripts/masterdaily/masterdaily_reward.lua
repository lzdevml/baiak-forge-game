...
local reward = {
	[0] = {id = 7443, amount = 1, chance = 20}, -- Double Exp Escriture
	[1] = {id = 13393, amount = 8, chance = 40}, -- silv
	[2] = {id = 13394, amount = 5, chance = 25}, -- gold t
	[3] = {id = 13353, amount = 15, chance = 35}, -- dream
	[4] = {id = 13354, amount = 10, chance = 35}, --cluster
	[5] = {id = 8981, amount = 30, chance = 90}, -- tick
	[6] = {id = 5953, amount = 30, chance = 10}, -- escriture		
}
		...
		for i = 0, #reward do
			if (reward[i].chance > rand) then
				if doPlayerAddItem(cid, reward[i].id, reward[i].amount) then
					...
					setPlayerStorageValue(cid, 42013, os.time()+20*60*60)
					return doPlayerSendTextMessage(cid, 27, "Você finalizou a Master Daily Quest e recebeu um item. Poderá fazer a Daily novamente em: ".. convertTime(getPlayerStorageValue(cid, 42013) - os.time()) ..".")
				else
