...
local reward = {
	[0] = {id = 11197, amount = 5, chance = 21}, -- Double Exp Escriture
	[1] = {id = 12468, amount = 2, chance = 32}, -- Exp Bonus 20%
	[2] = {id = 12640, amount = 1, chance = 28}, -- Refine Stone
	[3] = {id = 12426, amount = 1, chance = 35}, -- Stamina Refil
	[4] = {id = 5953, amount = 2, chance = 29}, -- Event Coin (2 charges)
	[5] = {id = 12422, amount = 10, chance = 27}, -- 150k
	[6] = {id = 10559, amount = 2, chance = 34}, -- 150k	
}
		...
		for i = 0, #reward do
			if (reward[i].chance > rand) then
				if doPlayerAddItem(cid, reward[i].id, reward[i].amount) then
					...
					return doPlayerSendTextMessage(cid, 27, "Você finalizou a Master Daily Quest e recebeu um item. Poderá fazer a Daily novamente em: ".. convertTime(getPlayerStorageValue(cid, 42011) - os.time()) ..".")
				else
