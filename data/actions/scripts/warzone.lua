...
if getPlayerStorageValue(cid, 45699) > 0 then
	...
	elseif wz5 == 5 then
		...
		doPlayerSendTextMessage(cid,22,"Você já pegou uma recompensa de warzone 2 nas ultimas 24 horas.")
	end
else
...
if getPlayerStorageValue(cid, 45698) > 0 then
	...
	elseif wz5 == 5 then
		...
		doPlayerSendTextMessage(cid,22,"Você já pegou uma recompensa de warzone 1 nas ultimas 24 horas.")
	end
else
