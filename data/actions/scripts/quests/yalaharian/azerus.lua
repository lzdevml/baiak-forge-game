-- Config #1 --  
local BlindField = {x = 374, y = 519, z = 3, stackpos=1} 
-- end --  
...
function onUse(cid, item, fromPosition, itemEx, toPosition) 
	local topLeft = {x = 364, y = 518, z = 3} 
	local buttomRight = {x = 386, y = 539, z = 3} 
	local monsters = getMonstersfromArea(topLeft, buttomRight) 
	local monsters1 = getMonstersfromArea(topLeft, buttomRight) 
	local tp = {x = 376, y = 537, z = 3} 
	local glo = {x = 376, y = 528, z = 3} 
	...
	local function createWall(p)
		local janek = doCreateItem(1387,1,{x = 377, y = 539, z = 2})
		doItemSetAttribute(janek, "aid", 9105)
	end

	local function createWalll(i)
		local ela = doCreateItem(1387,1,{x = 376, y = 537, z = 3})
		doItemSetAttribute(ela, "aid", 9106)
	end
	
	local wall0 = {x = 377, y = 539, z = 2, stackpos=1}
	local getwall0 = getThingfromPos(wall0)
	local wall1 = {x = 376, y = 537, z = 3, stackpos=1}
