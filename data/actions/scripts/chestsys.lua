local chests = {
	[6000] = {storage = 8900, item = 7900, amount = 1}, -- magma monocle
	[6003] = {storage = 8900, item = 2506, amount = 1}, -- winged helmet
	[6004] = {storage = 8001, item = 00, amount = 1}, -- magma coat
	[6006] = {storage = 8001, item = 8886, amount = 1}, -- lavos armor
	[6007] = {storage = 8002, item = 7894, amount = 1}, -- magma legs
	[6005] = {storage = 992123, item = 12645, amount = 1}, -- windborn colossus armor
	[6002] = {storage = 992123, item = 12640, amount = 1}, -- horned helmet
	[6008] = {storage = 992123, item = 2538, amount = 1}, -- knight legs
	...
	[6038] = {storage = 8016, item = 12655, amount = 1}, -- barao staff
	[6039] = {storage = 8016, item = 12654, amount = 1}, -- barao bow
	[6040] = {storage = 8016, item = 2390, amount = 1}, -- barao sword
	[6041] = {storage = 8016, item = 2444, amount = 1}, -- barao club
	[6042] = {storage = 8016, item = 8925, amount = 1}, -- barao axe
	...
	[6099] = {storage = 37890, item = 9693, amount = 1}, -- addon doll
	[39190] = {storage = 39190, item = 2641, amount = 1},
	[39191] = {storage = 39190, item = 2641, amount = 1},
	[39192] = {storage = 39190, item = 2641, amount = 1},
	[39193] = {storage = 39191, item = 2503, amount = 1},
	[39194] = {storage = 8001, item = 7899, amount = 1},
	[39195] = {storage = 8001, item = 8883, amount = 1},
	[39196] = {storage = 39194, item = 6300, amount = 1},
	[39197] = {storage = 8002, item = 2477, amount = 1},
	[39198] = {storage = 391921, item = 11253, amount = 1},
	[39199] = {storage = 8900, item = 2496, amount = 1},
	[39200] = {storage = 39194, item = 12658, amount = 1},
	[39201] = {storage = 39194, item = 10502, amount = 1},
	[39202] = {storage = 34189, item = 7424, amount = 1},
	[39203] = {storage = 34189, item = 7450, amount = 1},
	[39204] = {storage = 34189, item = 7417, amount = 1},
	[39205] = {storage = 34189, item = 7420, amount = 1},
	[39206] = {storage = 34189, item = 8854, amount = 1},
	[39207] = {storage = 55649, item = 12612, amount = 1},
	[39208] = {storage = 55649, item = 12656, amount = 1},
	[39209] = {storage = 55649, item = 12611, amount = 1},
	[39210] = {storage = 55650, item = 9693, amount = 1},
	[39211] = {storage = 55651, item = 12396, amount = 7},
	[39212] = {storage = 55652, item = 12575, amount = 7},
	[39213] = {storage = 26894, item = 5801, amount = 1},
	[39214] = {storage = 47775, item = 11128, amount = 1},
...
function onUse(cid,item,fromPosition,itemEx,toPosition)
	...
	elseif getPlayerFreeCap(cid) < (getItemWeightById(v.item)*v.amount) then
		doPlayerSendTextMessage(cid,MESSAGE_INFO_DESCR, "You need " .. (getItemWeightById(v.item)*v.amount) .. " capacity in order to get the item")
		return true
	end
	...
	doPlayerSendTextMessage(cid,22,"You have found a " .. getItemNameById(v.item) .. ".")
	return true
end